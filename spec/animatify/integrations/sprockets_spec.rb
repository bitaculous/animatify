describe Animatify::Integrations::SprocketsIntegration do
  ...
  describe '“fonts”' do
    context 'the “fonts” path exists' do
      it 'expands the load path' do
        Animatify::Integrations::SprocketsIntegration.setup fonts_path: fonts_path
  ...
  describe '“images”' do
    context 'the “images” path exists' do
      it 'expands the load path' do
        Animatify::Integrations::SprocketsIntegration.setup images_path: images_path
  ...
  describe '“javascripts”' do
    context 'the “javascripts” path exists' do
      it 'expands the load path' do
        Animatify::Integrations::SprocketsIntegration.setup javascripts_path: javascripts_path
  ...
  describe '“stylesheets”' do
    context 'the “stylesheets” path exists' do
      it 'expands the load path' do
        Animatify::Integrations::SprocketsIntegration.setup stylesheets_path: stylesheets_path
  ...
  describe '“vendor fonts”' do
    context 'the “vendor fonts” path exists' do
      it 'expands the load path' do
        Animatify::Integrations::SprocketsIntegration.setup vendor_fonts_path: vendor_fonts_path
  ...
  describe '“vendor images”' do
    context 'the “vendor images” path exists' do
      it 'expands the load path' do
        Animatify::Integrations::SprocketsIntegration.setup vendor_images_path: vendor_images_path
  ...
  describe '“vendor javascripts”' do
    context 'the “vendor javascripts” path exists' do
      it 'expands the load path' do
        Animatify::Integrations::SprocketsIntegration.setup vendor_javascripts_path: vendor_javascripts_path
  ...
  describe '“vendor stylesheets”' do
    context 'the “vendor stylesheets” path exists' do
      it 'expands the load path' do
        Animatify::Integrations::SprocketsIntegration.setup vendor_stylesheets_path: vendor_stylesheets_path
