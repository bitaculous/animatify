describe Animatify::Integrations::SassIntegration do
  ...
  describe '“stylesheets”' do
    context 'the “stylesheets” path exists' do
      it 'expands the load path' do
        Animatify::Integrations::SassIntegration.setup stylesheets_path: stylesheets_path
  ...
  describe '“vendor stylesheets”' do
    context 'the “vendor stylesheets” path exists' do
      it 'expands the load path' do
        Animatify::Integrations::SassIntegration.setup vendor_stylesheets_path: vendor_stylesheets_path
